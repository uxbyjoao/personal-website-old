    ...
    <div className="mt-14">
      ...
      <div>
        ...
        <p>
          ...
          InDesign, and even Lightroom (I'm a hobbyist photographer as well) is
          second nature to me. In fact, I started my UX career designing
      ...
      <div>
        ...
        <p>
          ...
          fidelity prototypes and microinteractions. What has drawn me to it is
          the fact that one can use React and JavaScript to create components
          and control the prototypes with more precision.
        </p>
      </div>
      <div>
        <h4>Front-End Development (HTML/CSS, ES6 JavaScript)</h4>
        <p>
          ...
          what I would say is enough development knowledge to be dangerous as a
          designer. In my current job, I am ocasionally given the oportunity to
